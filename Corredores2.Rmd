---
title: 'Corredores biologicos y cambio climático en el cono sur'
...
Bajo esta línea de estudio, el cambio climático y la fragmentación del hábitat se combinan formando una nueva problemática. Por efecto del cambio climático se predice que las especies cambien su área de distribución [@chen_rapid_2011], sin embargo es necesario que se dispersen hacia esta nueva área de distribucion potencial que ha de ser modelada. Debido a la presencia de hábitats fragmentados producto del proceso de urbanización, industrialización o cambios de uso de suelo, las especies no siempre podrán llegar a esta nueva área óptima. Para evitar problemas de conservación de especies debido a que estas no puedan dispersarse a areas optimas futuras, se requiere de corredores biológicos [@nunez_connectivity_2013; @rosenberg_biological_1997]. Estos corredores conectarian areas de distribucion actual con areas de distribucion potencial futura, lo cual tambien debe ser modelado para considerar las necesidades de habitat la especie, las variables que una especie pude soportar, la capacidad y tasa de dispersi?n, entre otros factores. Recientemente  una revisión a los métodos utilizados para la modelación espacial de corredores biologicos establecio....


#Herramientas actuales de conservacion: las areas protegidas

El concepto de "?rea protegida" se define en Chile como un ?rea definida geogr?ficamente que ha sido designada o regulada y administrada con la finalidad de alcanzar objetivos espec?ficos de conservaci?n (MINISTERIO DE RELACIONES EXTERIORES.Promulga Convenio sobre la Diversidad Biol?gica, adoptado el 5 de junio de 1992 en R?o de Janeiro, Rep?blica Federativa de Brasil. 1995).El Sistema Nacional de Areas Protegidas del Estado de Chile o SNASPE contempla 102 unidades de protecci?n abarcando un total de 14.715.570 ha que representan un 19,3% de la superficie nacional (Gerencia de ?reas Silvestres Protegidas Corporaci?n Nacional Forestal.2015. Restauraci?n ecol?gica en ?reas Silvestres Protegidas del Estado:Experiencias y desaf?os que contribuyen a la conservaci?n de la diversidad biol?gica del pa?s). Dentro de estas areas existen tres entidades adminstradas por el Estado a cargo de la Corporaci?n Nacional Forestal, CONAF: los Parques Nacionales que buscan proteccion y conservacion de ambientes particulares, las Reservas Nacionales que conservan en base a la utilizaci?n de recursos y los Monumentos Naturales que intentan conservar objetos espec?ficos o especies definidas en los cuales solo se puedde realizar investigacion cientifica o inspecciones gubernamentales (MINISTERIO DE RELACIONES EXTERIORES  T?tulo: CONVENCION PARA LA PROTECCION DE LA FLORA, LA FAUNA Y LAS BELLEZAS ESCENICAS NATURALES DE AMERICA 1967). Los Parques Nacionales abarcan una superfice nacional de 12,1%, las Reservas Nacionales 7,1% y los Monumentos Naturales solo un 0,04% (Gerencia de ?reas Silvestres Protegidas Corporaci?n Nacional Forestal.2015. Restauraci?n ecol?gica en ?reas Silvestres Protegidas del Estado:Experiencias y desaf?os que contribuyen a la conservaci?n de la diversidad biol?gica del pa?s).

A pasar de los intentos por conservar en el pa?s, s?lo tomando en cuenta condiciones actuales, se ha determinado que aproximadamente un 13% de las especies chilenas no se encuentran consideradas por las áreas protegidas de Chile [@marquet_how_2004; tognelli_how_2008]. Junto con esto, las soluciones que se toman a nivel nacional pueden ser ineficientes comparativamente con soluciones a nivel regional [@levin_biodiversity_2014; @mazor_collaboration_2013; mazor_large-scale_2014], donde se ha encontrado ahorros de hasta un 66% en costos económicos para proteger la misma cantidad de recursos naturales si se hace de forma coordinada entre varias naciones que si se hace como nacion individual [@@mazor_collaboration_2013].

Posibles soluciones a esta descoordinacion de esfuerzos se han descrito en torno a la creaci?n y mantenci?n de areas protegidas privadas (Sep?lveda y Villarroel 1995, Sep?lveda 1998) y la necesidad de conectividad entre ellas de forma fisica o funcional para asegurar recursos que puedan sustentar poblaciones viables (Simonetti y Acosta 2002, Simonetti et al. 2002). Estas ?reas
podr?an comprender parques privados de mayores extenciones para conservaci?n...
la acci?n de los due?os de tierras o importando mayormente la extensi?n de esta (Kamal et al Biodivers Conserv (2014) 23:2689-2704), contemplando campos de cultivos y jardines de casas (Gaston et al., 2005; Thompson et al.,2003). 
