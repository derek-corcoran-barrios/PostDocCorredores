...
podrían comprender parques privados de mayores extensiones para conservación, la acción de los dueños de tierras [@kamal2014should], contemplando campos de cultivos e incluso jardines de casas [@gaston2005urban; @thompson2003urban] , parques y hasta sitios abandonados [@savard2000biodiversity], (Gibson, 1998; Woodward et al., 2003). Estudios de biodiversidad urbana ya han demostrado que existe cierta conectividad entre estas áreas ya que por ejemplo en Inglatera no se han observado diferencias en la abundancia y riqueza de especies de visitantes de flores entre ambientes urbanos, campos de cultivo y reservas naturales [@baldock2015uk].
...
- Crear indices de idoneidad de habitat
- Habilidad de dispersión de las especies
- Metas de representatividad de especies
- Costo y presupuesto
- Optimización
