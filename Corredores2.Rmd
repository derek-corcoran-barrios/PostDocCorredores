...
library(plan)
key <- c(1:4)
description <- c("Preparacion base de datos", "Clasificacion de especies", "Modelacion distribucion actual", "modelacion distribucion futura", "Desarrollo modelos basados en agentes", "Generación de corredores para Chile")
data("gantt")
plot(gantt)
```
